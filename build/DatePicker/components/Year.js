...
var Year = /** @class */ (function (_super) {
    ...
    Year.prototype.render = function () {
        ...
        return (React.createElement(Typography_1.default, __assign({ role: "button", component: "div", className: clsx_1.default(classes.root, (_a = {},
                ...
                _a)), tabIndex: disabled ? -1 : 0, onClick: this.handleClick, onKeyPress: this.handleClick, color: selected ? 'primary' : 'default', variant: selected ? 'headline' : 'subheading', children: children }, other)));
    };
    Year.propTypes = {
