    ...
    DatePicker.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(PickerToolbar_1.default, { className: clsx_1.default((_a = {}, _a[classes.toolbarCenter] = this.isYearOnly, _a)) },
                !this.isYearOnly && !this.isYearAndMonth && (React.createElement("div", null,
                    React.createElement(ToolbarButton_1.default, { variant: "button", onClick: this.isYearOnly ? undefined : this.openYearSelection, selected: openView === 'year', label: utils.getYearText(this.date) }),
                    React.createElement(ToolbarButton_1.default, { variant: "button", onClick: this.openMonthSelection, selected: openView === 'month', label: utils.getMonthText(this.date) }),
                    React.createElement(ToolbarButton_1.default, { variant: "headline", onClick: this.openCalendar, selected: openView === 'day', label: utils.getDatePickerHeaderText(this.date) }))),
                this.isYearOnly && (React.createElement(ToolbarButton_1.default, { variant: this.isYearOnly ? 'h3' : 'subtitle1', onClick: this.isYearOnly ? undefined : this.openYearSelection, selected: openView === 'year', label: utils.getYearText(this.date) })),
                this.isYearAndMonth && (React.createElement("div", null,
                    ...
                    React.createElement(ToolbarButton_1.default, { variant: "h4", onClick: this.openMonthSelection, selected: openView === 'month', label: utils.getMonthText(this.date) })))),
            this.props.children,
